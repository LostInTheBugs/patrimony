...
DISCLAIMERS = { "Démo publique — données fictives à but d'illustration. Aucun compte réel n'est connecté.": { "en": "Public demo — fictional data for illustration purposes. No real account is connected.", "de": "Öffentliche Demo – fiktive Daten zur Veranschaulichung. Es ist kein echtes Konto verbunden.", "lu": "Ëffentlech Demo — fiktiv Donnéeën zu Illustratiounszwecker. Kee reellen Compte ass verbonnen." } }
